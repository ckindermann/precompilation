...
public class MSCAMaterialiser {
    ...
    public static void main(String[] args) throws  Exception {
        ...
        try{ 
            ...
            MostSpecificAssertions msca  = new MostSpecificAssertions(ontology, reasoner); 
            OntologySaver.saveAxioms(msca.getAxioms(), outputPath + "/" + ontologyName); 
