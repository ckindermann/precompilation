 ...
 *
 * check whether ontology has a non empty abox 
 * 
 *
 */
public class AboxEmptinessCheck {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String emptinessCheckOutput = outputPath + "/aboxCheck";
        ...
        //perform check
        try{
            if(AboxEmptinessCheck.hasAbox(OntologyLoader.load(ontFilePath))){
    ...
    public static boolean hasAbox(OWLOntology ontology){
