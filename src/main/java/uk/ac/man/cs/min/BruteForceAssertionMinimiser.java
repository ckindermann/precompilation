 ...
 */
public class BruteForceAssertionMinimiser { 
    ...
    public static void main(String[] args) throws  Exception {
        ...
        Set<OWLAxiom> assertions = new HashSet<>(ontology.getAxioms(AxiomType.CLASS_ASSERTION, Imports.INCLUDED));

        Minimiser minimiser = new Minimiser(ontology,reasonername,timeout);
        minimiser.identifyRedundancies(assertions);
